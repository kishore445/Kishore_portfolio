...
const Resume = () => {
  return (
    <div className=" md:h-[100vh]  bg-fixed text-white flex justify-center" style={{backgroundImage:`url(${image1})`}}>
        ...
        <a href="Kishore_portfolio-master\src\components\Resume.js" download="Resume.pdf"className='bg-slate-800 text-4xl rounded italic py-4 px-4'><h3><FontAwesomeIcon icon={faDownload} />  DownLoad Resume  </h3></a>
        </div>
